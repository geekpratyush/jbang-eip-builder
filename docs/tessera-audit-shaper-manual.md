# Tessera Audit Shaper - Enterprise Security Manual

## Library Information
- **Artifact ID**: `tessera-audit-shaper`
- **Dependency**: `mvn:com.tessera:tessera-audit-shaper:1.0.0-SNAPSHOT`
...
2. **Global Property**: Camel property `tessera.audit.crypto.key` (set in `application.properties`).
3. **Environment Variable**: `TESSERA_AUDIT_CRYPTO_KEY`.
