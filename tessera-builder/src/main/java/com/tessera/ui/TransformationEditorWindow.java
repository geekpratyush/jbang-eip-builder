...
public class TransformationEditorWindow {
    ...
    private com.tessera.ui.components.MonacoEditorPane editorSourceRaw;
    private com.tessera.ui.components.MonacoEditorPane editorSourceXml;
    private com.tessera.ui.components.MonacoEditorPane editorLogic;
    private com.tessera.ui.components.MonacoEditorPane editorTarget;
    ...
    public void show() {
        ...
        if (isEnrichment) {
            ...
            VBox originalBox = new VBox(new Label("Original Source"), editorSourceRaw = new com.tessera.ui.components.MonacoEditorPane("xml"));
            VBox.setVgrow(editorSourceRaw, Priority.ALWAYS);
            
            VBox truncatedBox = new VBox(new Label("Truncated Source (to be enriched)"), editorSourceXml = new com.tessera.ui.components.MonacoEditorPane("xml"));
            ...
            VBox rawBox = new VBox(new Label("Raw Source"), editorSourceRaw = new com.tessera.ui.components.MonacoEditorPane("text"));
            VBox.setVgrow(editorSourceRaw, Priority.ALWAYS);
            
            VBox xmlBox = new VBox(new Label("Converted XML"), editorSourceXml = new com.tessera.ui.components.MonacoEditorPane("xml"));
            VBox.setVgrow(editorSourceXml, Priority.ALWAYS);
            ...
            editorSourceXml = new com.tessera.ui.components.MonacoEditorPane("xml");
        ...
        editorLogic = new com.tessera.ui.components.MonacoEditorPane("xml");
        ...
        editorTarget = new com.tessera.ui.components.MonacoEditorPane("xml");
