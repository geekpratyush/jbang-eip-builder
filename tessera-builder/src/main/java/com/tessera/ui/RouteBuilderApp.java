    ...
    private static void generateEmbeddedMongoHelper(java.io.File targetFile) {
        try {
            ...
            String content = "package com.tessera.simulator;\n\n"
                    ...
                    + "            } catch (Exception e) {\n"
                    + "                if (p == 27035) {\n"
                    + "                    LOG.error(\"Failed to bind to any port in range 27017-27035\", e);\n"
                    + "                    throw new RuntimeException(\"Could not bind MongoDB to any free port\", e);\n"
                    + "                }\n"
                    + "                LOG.warn(\"Port \" + p + \" already in use, trying next port...\");\n"
                    + "            }\n"
                    + "        }\n"
