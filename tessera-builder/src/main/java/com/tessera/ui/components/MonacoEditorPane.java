...
public class MonacoEditorPane extends VBox {
    ...
    public MonacoEditorPane(String language) {
        ...
        com.tessera.ui.RouteBuilderApp.installClipboardShortcuts(webView);
            ...
            <body>
                ...
                <script>
                    ...
                    require(['vs/editor/editor.main'], function() {
                        ...
                        window.setTheme = function(t, bg) {
                            if (bg) {
                                var base = (t === 'vs-dark' || t === 'hc-black') ? t : 'vs';
                        ...
                        window.showDiagnostics = function(json) {
                            try {
                                var markers = JSON.parse(json).map(function(d) {
                                    return {
    ...
    private void onThemeChanged(String themeName) {
        ...
        if (themeClass.equals("theme-solarized-light")) {
            theme = "vs"; bgColor = "#fdf6e3";
        } else if (themeClass.equals("theme-tokyo-light")) {
            theme = "vs"; bgColor = "#d5d6db";
        } else if (themeClass.equals("theme-material-light")) {
            theme = "vs"; bgColor = "#fafafa";
        } else if (themeClass.contains("light")) {
            theme = "vs"; bgColor = "#ffffff";
        } else if (themeClass.equals("theme-cyberpunk") || themeClass.equals("theme-hacker")) {
            theme = "hc-black"; bgColor = "#000000";
        } else if (themeClass.equals("theme-nordic")) {
            theme = "vs-dark"; bgColor = "#2e3440";
        } else if (themeClass.equals("theme-dracula")) {
            theme = "vs-dark"; bgColor = "#282a36";
        } else if (themeClass.equals("theme-monokai")) {
            theme = "vs-dark"; bgColor = "#2d2a2e";
        } else if (themeClass.equals("theme-midnight")) {
            theme = "vs-dark"; bgColor = "#05070a";
        }

        try {
            engine.executeScript("window.setTheme('" + theme + "', '" + bgColor + "');");
