...
public class ThemeManager {
    ...
    private static void applyThemeToRoot(Parent root) {
        ...
        String selectionText = "white";
        String iconColor = "#d4d4d4";

        if (currentThemeClass.equals("theme-intellij-light")) {
            bgPrimary = "#ffffff"; bgSecondary = "#f3f3f3"; accentPrimary = "#005fb8";
            textMain = "#1a1a1a"; textDim = "#5a5a5a"; borderColor = "#c8c8c8"; 
            selectionColor = "#90c9ff"; selectionText = "#1a1a1a"; iconColor = "#1a1a1a";
        } else if (currentThemeClass.equals("theme-material-light")) {
            bgPrimary = "#fafafa"; bgSecondary = "#ffffff"; accentPrimary = "#00bcd4";
            textMain = "#212121"; textDim = "#757575"; borderColor = "#e0e0e0"; 
            selectionColor = "#80deea"; selectionText = "#212121"; iconColor = "#212121";
        } else if (currentThemeClass.equals("theme-solarized-light")) {
            bgPrimary = "#fdf6e3"; bgSecondary = "#eee8d5"; accentPrimary = "#b58900";
            textMain = "#657b83"; textDim = "#93a1a1"; borderColor = "#ccc4b0"; 
            selectionColor = "#d3cbb7"; selectionText = "#657b83"; iconColor = "#268bd2";
        } else if (currentThemeClass.equals("theme-tokyo-light")) {
            bgPrimary = "#d5d6db"; bgSecondary = "#cbccd1"; accentPrimary = "#0f4b6e";
            textMain = "#343b58"; textDim = "#5c6166"; borderColor = "#a4a5a8"; 
            selectionColor = "#a8b8d0"; selectionText = "#343b58"; iconColor = "#8c4351";
        } else if (currentThemeClass.contains("light")) {
            bgPrimary = "#ffffff"; bgSecondary = "#f3f3f3"; accentPrimary = "#005fb8";
            textMain = "#1a1a1a"; textDim = "#5a5a5a"; borderColor = "#c8c8c8"; 
            selectionColor = "#90c9ff"; selectionText = "#1a1a1a"; iconColor = "#1a1a1a";
        } else if (currentThemeClass.equals("theme-nordic")) {
            bgPrimary = "#2e3440"; bgSecondary = "#3b4252"; accentPrimary = "#88c0d0";
            textMain = "#eceff4"; textDim = "#d8dee9"; borderColor = "#4c566a"; 
            selectionColor = "#434c5e"; selectionText = "white"; iconColor = "#8fbcbb";
            ...
            selectionColor = "#44475a"; selectionText = "white"; iconColor = "#f8f8f2";
        } else if (currentThemeClass.equals("theme-monokai")) {
            bgPrimary = "#2d2a2e"; bgSecondary = "#221f22"; accentPrimary = "#ffd866";
            textMain = "#fcfcfa"; textDim = "#939293"; borderColor = "#403e41"; 
            selectionColor = "#5b595c"; selectionText = "white"; iconColor = "#ffd866";
            ...
            selectionColor = "#3d102e"; selectionText = "white"; iconColor = "#ff007c";
        }
        ...
        sb.append("-sui-selection-text: ").append(selectionText).append(";");
